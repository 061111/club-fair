...
const CLUBS = [
  ...
  { id: 85, name: "茶几动漫社", cat: "文化艺术", module: "renwen", logo: "👾", tags: ["anime", "art", "boardgame"],
    ...
    qq: "100100117", booth: "", status: "closed", photos: [] },
...
const BOOTH_LAYOUT = {
  segments: [
    ...
    { from: 51,  to: 68,  x1: 94.57, y1: 14.38, x2: 94.57, y2: 85.61, kind: "ring" }, /* 右竖列 */
    { from: 134, to: 117, x1: 5.49, y1: 14.93, x2: 5.49, y2: 85.63, kind: "ring" },   /* 左竖列（134 顶 → 117 底） */
    { from: 93,  to: 104, x1: 6.41, y1: 88.27, x2: 38.59, y2: 88.27, kind: "ring" },  /* 底左上横排 */
    { from: 105, to: 116, x1: 8.26, y1: 94.04, x2: 38.67, y2: 94.04, kind: "ring" },  /* 底左下横排 */
    { from: 80,  to: 69,  x1: 60.83, y1: 88.27, x2: 93.33, y2: 88.27, kind: "ring" }, /* 底右上横排（80 左 → 69 右） */
    { from: 81,  to: 92,  x1: 60.73, y1: 94.04, x2: 91.14, y2: 94.04, kind: "ring" }, /* 底右下横排 */
    { from: 1,   to: 11,  x1: 24.55, y1: 25.98, x2: 24.55, y2: 61.36, kind: "inner" },/* 内左列A */
    { from: 23,  to: 13,  x1: 26.81, y1: 25.98, x2: 26.81, y2: 61.36, kind: "inner" },/* 内左列B（23 顶 → 13 底） */
    { from: 12,  to: 12,  x1: 26.06, y1: 69.27, x2: 26.06, y2: 69.27, kind: "inner", wide: true }, /* 宽格 */
