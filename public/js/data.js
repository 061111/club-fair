...
const BOOTH_LAYOUT = {
  segments: [
    ...
    { from: 51,  to: 68,  x1: 94.57, y1: 14.38, x2: 94.57, y2: 85.15, kind: "ring" }, /* 右竖列 */
    { from: 134, to: 117, x1: 5.49, y1: 14.93, x2: 5.49, y2: 85.15, kind: "ring" },   /* 左竖列（134 顶 → 117 底） */
    { from: 93,  to: 104, x1: 6.85, y1: 88.27, x2: 38.59, y2: 88.27, kind: "ring" },  /* 底左上横排 */
    { from: 105, to: 116, x1: 8.26, y1: 94.04, x2: 38.67, y2: 94.04, kind: "ring" },  /* 底左下横排 */
    { from: 80,  to: 69,  x1: 60.83, y1: 88.27, x2: 92.85, y2: 88.27, kind: "ring" }, /* 底右上横排（80 左 → 69 右） */
    { from: 81,  to: 92,  x1: 60.73, y1: 94.04, x2: 91.14, y2: 94.04, kind: "ring" }, /* 底右下横排 */
    { from: 1,   to: 11,  x1: 24.25, y1: 24.9, x2: 24.25, y2: 62.4, kind: "inner" }, /* 内左列A */
    { from: 23,  to: 13,  x1: 27.15, y1: 24.9, x2: 27.15, y2: 62.4, kind: "inner" }, /* 内左列B（23 顶 → 13 底） */
